...
export default function LoadingScreen() {
  return (
    <div className="bg-white w-full h-full rounded-xl">
      {/* <div className="items-center justify-center rounded-full w-14 h-14 bg-gradient-to-tr from-indigo-500 to-pink-600">
      ...
      {/* <div role="status" className="w-full h-full min-h-80">
