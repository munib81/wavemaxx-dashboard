            ...
            <div className="flex items-center">
              ...
              <div className="relative">
                {session ? (
                  ...
                  <Link
                    href="/login"
                    className="flex ml-3 items-center text-sm font-medium p-2 rounded-lg  hover:bg-gray-200 bg-gray-100 border border-gray-200 md:mr-0  text-black"
                    type="button"
                  >
                    <span className="mx-1 md:flex hidden ">login</span>
                  </Link>
                )}
              </div>
            </div>
