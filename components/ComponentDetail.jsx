...
export default function ComponentDetail({ variation }) {
  const [currentDisplay, setCurrentDisplay] = useState("preview");
  //   const reactCode = `<div className="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 bg-gray-400 border-gray-700">
