            ...
            <div className="mt-2">
              {isUserPremium && component.visibility === "paid" && (
                ...
                >
                  <button
                    type="submit"
                    id="copybutton"
                    className={`text-white justify-center flex items-center bg-gradient-to-r from-blue-700 to-purple-600 hover:from-blue-800 hover:to-purple-700  w-full  font-medium rounded-lg md:text-sm text-xs md:px-5 md:py-2.5 px-2 py-2 mb-2 bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-blue-800`}
                  >
                    <svg
              ...
              {!isUserPremium && component.visibility === "paid" && (
                <Link
                  ...
                  href={`/pricing`}
                  id="copybutton"
                  className={`text-white justify-center flex items-center bg-yellow-400 hover:bg-yellow-500 w-full  font-medium rounded-lg md:text-sm text-xs md:px-5 md:py-2.5 px-2 py-2 mb-2  focus:outline-none focus:ring-blue-800`}
                >
                  <svg
                    className="w-3.5 h-3.5 me-2.5"
                    aria-hidden="true"
              ...
              <div className="mt-2 group rounded-xl border border-gray-700 overflow-hidden">
                <img
                  // src={component.image}
                  src={`/assets/${component.folderName}/${component.fileName}.png`}
                  alt="thumbnail"
                  className="w-full rounded-xl  aspect-auto object-cover  "
                  loading="lazy"
                  blurdataurl={component.image}
                />
              </div>
