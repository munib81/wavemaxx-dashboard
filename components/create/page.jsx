...
export default function Create() {
  ...
  return (
    <section className="bg-white bg-gray-900 rounded-md shadow-lg">
      <div className="py-8 px-4 mx-auto max-w-2xl lg:py-8">
        <h2 className="text-slate-900 text-2xl mb-3">Create a Course</h2>
        <div className="border-b border-gray-200 border-gray-700 mb-6">
                  ...
                  <button
                    ...
                    className={
                      displayedForm === tab.form
                        ? "inline-flex items-center justify-center p-4 text-purple-600 border-b-2 border-purple-600 rounded-t-lg active text-purple-500 border-purple-500 group"
                        : "inline-flex items-center justify-center p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 hover:text-gray-300 group"
                    }
                  >
                    <Icon className="mr-2 w-4 h-4text-gray-400 group-hover:text-gray-500 text-gray-500 group-hover:text-gray-300" />
                    {tab.title}
                  </button>
                </li>
              );
